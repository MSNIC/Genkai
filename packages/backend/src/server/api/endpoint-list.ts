...
export * as 'admin/approvals/approve' from './endpoints/admin/approvals/approve.js';
export * as 'admin/approvals/list' from './endpoints/admin/approvals/list.js';
export * as 'admin/approvals/reject' from './endpoints/admin/approvals/reject.js';
export * as 'admin/approvals/send-message' from './endpoints/admin/approvals/send-message.js';
...
export * as 'eew/test' from './endpoints/eew/test.js';
...
export * as 'signup/check-status' from './endpoints/signup/check-status.js';
export * as 'signup/send-message' from './endpoints/signup/send-message.js';
...
export * as 'voice-rooms/create' from './endpoints/voice-rooms/create.js';
export * as 'voice-rooms/end' from './endpoints/voice-rooms/end.js';
export * as 'voice-rooms/join' from './endpoints/voice-rooms/join.js';
export * as 'voice-rooms/leave' from './endpoints/voice-rooms/leave.js';
export * as 'voice-rooms/list' from './endpoints/voice-rooms/list.js';
export * as 'voice-rooms/list-participants' from './endpoints/voice-rooms/list-participants.js';
export * as 'voice-rooms/list-recordings' from './endpoints/voice-rooms/list-recordings.js';
export * as 'voice-rooms/list-speak-requests' from './endpoints/voice-rooms/list-speak-requests.js';
export * as 'voice-rooms/request-to-speak' from './endpoints/voice-rooms/request-to-speak.js';
export * as 'voice-rooms/respond-to-speak-request' from './endpoints/voice-rooms/respond-to-speak-request.js';
export * as 'voice-rooms/show' from './endpoints/voice-rooms/show.js';
export * as 'voice-rooms/start' from './endpoints/voice-rooms/start.js';
