...
export const DI = {
	...
	voiceRoomsRepository: Symbol('voiceRoomsRepository'),
	voiceRoomParticipantsRepository: Symbol('voiceRoomParticipantsRepository'),
	voiceRoomSpeakRequestsRepository: Symbol('voiceRoomSpeakRequestsRepository'),
	voiceRoomRecordingsRepository: Symbol('voiceRoomRecordingsRepository'),
